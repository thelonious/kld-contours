(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('kld-polynomial'), require('kld-affine')) :
  typeof define === 'function' && define.amd ? define(['exports', 'kld-polynomial', 'kld-affine'], factory) :
  (global = global || self, factory(global.KldContours = {}, global.kldPolynomial, global.kldAffine));
}(this, function (exports, kldPolynomial, kldAffine) { 'use strict';
  ...
  function () {
    ...
    _createClass(CubicBezier2D, [{
      ...
      value: function getBernsteinPolynomials() {
        ...
        var c0 = this.p1;
        return {
          x: new kldPolynomial.Polynomial(c3.x, c2.x, c1.x, c0.x),
          y: new kldPolynomial.Polynomial(c3.y, c2.y, c1.y, c0.y)
        };
      }
      /**
      ...
      value: function getArcLengthPolynomial() {
        ...
        if (!this.hasOwnProperty("arcLengthPolynomial")) {
          ...
          this.arcLengthPolynomial = new kldPolynomial.SqrtPolynomial(9 * (c3.x * c3.x + c3.y * c3.y), 12 * (c2.x * c3.x + c2.y * c3.y), 4 * (c2.x * c2.x + c2.y * c2.y) + 6 * (c1.x * c3.x + c1.y * c3.y), 4 * (c1.x * c2.x + c1.y * c2.y), c1.x * c1.x + c1.y * c1.y);
      ...
      value: function getBoundingBox() {
        ...
        roots.forEach(function (t) {
          if (0 <= t && t <= 1) {
            var testPoint = new kldAffine.Point2D(polys.x.eval(t), polys.y.eval(t));
      ...
      value: function getAlignedBoundingBox() {
        return {
          ...
          transform: new kldAffine.Matrix2D().translation(this.p1.x, this.p1.y).rotateFromVector(kldAffine.Vector2D.fromPoints(this.p1, this.p4))
        };
      }
      /**
       *  getAlignedBezier
      ...
      value: function getAlignedBezier() {
        var matrix = kldAffine.Matrix2D.translation(this.p1.x, this.p1.y) // move p1 to the origin
        .rotateFromVector(kldAffine.Vector2D.fromPoints(this.p1, this.p4)) // rotate vector from p1 to p4 to x-axis
      ...
      value: function toPolygon2D(flatness) {
        var points = [];
        var zeroVector = new kldAffine.Vector2D(0, 0);
        ...
        function tesselateInterior(p1, p2, p3, p4) {
          ...
          var baseline = kldAffine.Vector2D.fromPoints(p1, p4);
          var tangent1 = kldAffine.Vector2D.fromPoints(p1, p2);
          var tangent2 = kldAffine.Vector2D.fromPoints(p4, p3);
          var dmax = 0;
          ...
          if (dmax > flatness) {
            ...
            points.push(new kldAffine.Point2D(p10.x, p10.y));
  ...
  function () {
    ...
    _createClass(QuadraticBezier2D, [{
      ...
      value: function getBernsteinPolynomials() {
        ...
        var c0 = this.p1;
        return {
          x: new kldPolynomial.Polynomial(c2.x, c1.x, c0.x),
          y: new kldPolynomial.Polynomial(c2.y, c1.y, c0.y)
        };
      }
      /**
       *  getArcLengthPolynomial
      ...
      value: function getArcLengthPolynomial() {
        ...
        if (!this.hasOwnProperty("arcLengthPolynomial")) {
          ...
          this.arcLengthPolynomial = new kldPolynomial.SqrtPolynomial(4 * (c2.x * c2.x + c2.y * c2.y), 4 * (c1.x * c2.x + c1.y * c2.y), c1.x * c1.x + c1.y * c1.y); // this.arcLength = this.arcLengthPolynomial.romberg(0, 1);
      ...
      value: function getAlignedBoundingBox() {
        return {
          bbox: this.getAlignedBezier().getBoundingBox(),
          transform: kldAffine.Matrix2D.translation(this.p1.x, this.p1.y).rotateFromVector(kldAffine.Vector2D.fromPoints(this.p1, this.p3))
        };
      }
      /**
       *  getAlignedBezier
      ...
      value: function getAlignedBezier() {
        var matrix = kldAffine.Matrix2D.translation(this.p1.x, this.p1.y) // move p1 to the origin
        .rotateFromVector(kldAffine.Vector2D.fromPoints(this.p1, this.p3)) // rotate vector from p1 to p4 to x-axis
        .inverse(); // reverse transforms
        // apply to each point and create new Bezier
      ...
      value: function toPolygon2D(flatness) {
        ...
        function tesselateInterior(p1, p2, p3) {
          ...
          var baseline = kldAffine.Vector2D.fromPoints(p1, p3);
          var tangent = kldAffine.Vector2D.fromPoints(p1, p2);
          var dmax = 0;
          ...
          if (dmax > flatness) {
            ...
            points.push(new kldAffine.Point2D(p6.x, p6.y));
  ...
  function () {
    ...
    _createClass(Rectangle2D, [{
      ...
      key: "toPolygon2D",
      value: function toPolygon2D() {
        return new Polygon2D([new kldAffine.Point2D(this.x, this.y), new kldAffine.Point2D(this.x + this.width, this.y), new kldAffine.Point2D(this.x + this.width, this.y + this.height), new kldAffine.Point2D(this.x, this.y + this.height)]);
      }
    }]);
  ...
  exports.CubicBezier2D = CubicBezier2D;
  exports.Ellipse2D = Ellipse2D;
  exports.Line2D = Line2D;
  exports.Polygon2D = Polygon2D;
  exports.QuadraticBezier2D = QuadraticBezier2D;
